...
namespace MaxMind.MinFraud.Request
{
    ...
    public sealed class Device
    {
        ...
        /// site.</param>
        /// <param name="trackingToken">The tracking token generated by the
        /// Device Tracking Add-on for explicit device linking.</param>
        public Device(
        ...
        public Device(
            ...
            double? sessionAge,
            string? sessionId
        ) : this(ipAddress, userAgent, acceptLanguage, sessionAge, sessionId, null)
        {
        }
        ...
        /// <summary>
        /// The tracking token generated by the Device Tracking Add-on
        ...
        {
            return $"IPAddress: {IPAddress}, UserAgent: {UserAgent}, AcceptLanguage: {AcceptLanguage}, SessionAge: {SessionAge}, SessionId: {SessionId}, TrackingToken: {TrackingToken}";
        }
    }
}
